...
- 客户端代码     客户端则为入口函数，这时客户端不用关心具体产品的产生，只需要请求则可以拿到自己要的产品
...
*这里我们使用 GetFurnitureFactory() 函数根据家具风格来初始化工厂*
...
![solution1-2x.png](docs/imgs/solution1-2x.png)
![solution1-2x.png](docs/imgs/solution2-2x.png)